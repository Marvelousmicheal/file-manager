...
const features = [
  ...
  },
  {
    ...
    image: "/icons/icon-location.png",
    alt: "Customizable",
  },
  {
    name: "Support",
    image: "/icons/icon-support-1.png",
    description:
...
function SecondSection() {
  return (
    <>
      ...
      flex-col items-center flex justify-center pb-10"
      >
        <div className="justify-center md:w-1/3 p-5">
          <div className="bg-gradient-to-r from-blue-900 to-blue-600 bg-clip-text text-transparent text-4xl md:text-6xl font-bold pb-10 ">
            From startup to enterprise, Filey is built for every type of
            business.
          </div>
